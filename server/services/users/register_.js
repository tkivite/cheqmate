                                                                                                                                ...
                                                                                                                                if (err4) {
                                                                                                                                    ...
                                                                                                                                    if (usl_state_v = 1) {
                                                                                                                                        conn.query('insert into users_signup_log (usl_name,usl_fullname,usl_email,usl_password,usl_phone,usl_login_type,usl_third_party_token,usl_device_type,usl_device_version,usl_device_id,usl_ip,usl_mac,usl_date,usl_state,usl_app_version)' +
                                                                                                                                            'values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', [u_name_v, u_fullname_v, u_email_v, UtilityFunctions.generateMD5(u_password_v), u_phone_v, u_login_type_v, u_third_party_token_v, ud_device_type_v, ud_device_version_v, ud_device_id_v, usl_ip_v, usl_mac_v, NOW(), usl_state_v, ud_app_version_v],
                                                                                                                                            function (err) {
                                                                                                                                                if (err) {
                                                                                                                                                    conn.rollback(function () {
                                                                                                                                                        throw err;
                                                                                                                                        ...
                                                                                                                                        conn.query('insert into users_signup_log (usl_name,usl_fullname,usl_email,usl_password,usl_phone,usl_login_type,usl_third_party_token,usl_device_type,usl_device_version,usl_device_id,usl_ip,usl_mac,usl_date,usl_state,usl_app_version)' +
                                                                                                                                            'values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', [u_name_v, u_fullname_v, u_email_v, u_password_v, u_phone_v, u_login_type_v, u_third_party_token_v, ud_device_type_v, ud_device_version_v, ud_device_id_v, usl_ip_v, usl_mac_v, NOW(), usl_state_v, ud_app_version_v],
                                                                                                                                            function (err) {
                                                                                                                                                if (err) {
                                                                                                                                                    conn.rollback(function () {
                                                                                                                                                        throw err;
